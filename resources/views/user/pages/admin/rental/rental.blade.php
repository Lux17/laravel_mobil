    ...
    <div class="container-rental mx-15">
        ...
        @method('POST')
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="rentalName" name="mobil_id" required>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label for="rentalName">Mobil Id</label>:</label>
                <input type="text" class="form-control" id="rentalName" value="{{$rentals->mobil_id}}" name="mobil_id" required>
