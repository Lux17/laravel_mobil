    ...
    <div class="container-mobil mx-15">
        ...
        @method('POST')
            <div class="form-group"></div>
                <label for="mobilName">Brand_Id</label>:</label>
                <input type="text" class="form-control" id="mobilName" name="brand_id" required>
                ...
                <label for="mobilName">Status</label>:</label>
                <input type="text" class="form-control" id="mobilName" name="status" required>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
              <label for="mobilName">Brand_Id</label>:</label>
              <input type="text" class="form-control" id="mobilName" value="{{$mobils->brand_id}}" name="brand_id" required>
              ...
              <label for="mobilName">Status</label>:</label>
              <input type="text" class="form-control" id="mobilName" value="{{$mobils->status}}" name="status" required>
